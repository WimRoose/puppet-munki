...
class munki (
  ...
  String $munkitools_python_source,
  ...
  String $munkitools_python_receipt,
  ...
  String $munkitools_python_checksum,
  ...
  String $munkitools_python_version,
